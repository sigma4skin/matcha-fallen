...
local win = Menu.new({ Name = "disconnect", Suffix = ".wtf", Key = "f1" })
...
do
    ...
    local left = combat:Panel({ Side = "left", Tabs = { "Aimbot", "Other" } })
    local right = combat:Panel({ Side = "right", Tabs = { "Misc", "Weapon" } })

    local aim = left:Page("Aimbot")
    aim:Toggle({ Name = "Aimbot", Key = "b", Help = "master switch for the aimbot" })
    aim:Dropdown({ Name = "Aimbot Bones", Multi = true,
        Values = { "Head", "Chest", "Stomach", "Arms", "Legs" },
        Default = { Head = true, Chest = true } })
    aim:Toggle({ Name = "Silent Aimbot", Default = true,
        Help = "aim without moving the camera" })
    aim:Slider({ Name = "Silent Aim Spread", Default = 30, Suffix = "%" })
    aim:Dropdown({ Name = "Target Options", Multi = true,
        Values = { "Target Wounded", "Target", "Target Team", "Target NPC" },
        Default = { ["Target Wounded"] = true, Target = true } })
    aim:Toggle({ Name = "Aimbot Visible Check", Default = true,
        Help = "only aim at targets you can see" })
    aim:Toggle({ Name = "Aimbot Lock Target", Default = true,
        Help = "keep the same target until it dies" })
    aim:Toggle({ Name = "Bullet Teleport", Default = true,
        Help = "teleport the projectile to the target" })
    aim:Toggle({ Name = "Target Behind Wall", Default = true, Key = "b",
        Help = "allow targets with no line of sight" })
    aim:Toggle({ Name = "Desync", Default = true, Key = "b",
        Help = "desynchronise the server side position" })
    aim:Slider({ Name = "Desync Amount", Default = 100, Suffix = "%", Pad = 0 })
    aim:Toggle({ Name = "Desync Auto Stop", Default = true, Help = "stop desync while shooting" })
    aim:Toggle({ Name = "Auto Shoot", Default = true, Help = "fire once a target is locked" })
    aim:Dropdown({ Name = "Auto Shoot Options", Multi = true, Pad = -2,
        Values = { "Remove Animation", "Rapid Fire", "No Sway", "No Recoil" },
        Default = { ["Remove Animation"] = true, ["Rapid Fire"] = true } })
    aim:Toggle({ Name = "Instant Hit", Default = true, Help = "no projectile travel time" })

    local other = left:Page("Other")
    other:Toggle({ Name = "Auto Reload", Default = true, Help = "reload when the mag runs dry" })
    other:Toggle({ Name = "Auto Heal", Key = "h", Help = "use a med below the threshold" })
    other:Slider({ Name = "Heal Below", Default = 40, Min = 1, Max = 99, Suffix = "hp" })
    other:Toggle({ Name = "Auto Eat", Help = "eat when hunger drops" })
    other:Toggle({ Name = "Auto Upgrade", Help = "upgrade the block you look at" })
    other:Dropdown({ Name = "Upgrade Tier", Values = { "Wood", "Stone", "Metal", "Armored" },
        Default = "Metal" })
    other:Toggle({ Name = "Auto Farm", Help = "hit the closest node" })
    other:Slider({ Name = "Farm Range", Default = 4, Min = 1, Max = 12, Suffix = "m" })

    local misc = right:Page("Misc")
    misc:Toggle({ Name = "Draw Target Line", Color = white, Help = "line to the current target" })
    misc:Toggle({ Name = "Draw FOV", Default = true, Color = white, Help = "draw the fov circle" })
    misc:Toggle({ Name = "Dynamic FOV", Default = true, Help = "scale the fov with the weapon" })
    misc:Slider({ Name = "Aimbot FOV", Default = 188, Max = 1000, Suffix = "px" })
    misc:Toggle({ Name = "Silent Aimbot Hitchance", Default = true,
        Help = "roll a hit chance before firing" })
    misc:Slider({ Name = "Hitchance Amount", Default = 100, Suffix = "%" })
    misc:Toggle({ Name = "Pierce", Default = true, Help = "shoot through soft surfaces" })
    misc:Toggle({ Name = "No Team Damage", Default = true, Help = "never target teammates" })
    misc:Dropdown({ Name = "Hit Material", Width = 123, Height = 22, CapGap = 22,
        Values = { "None", "Flesh", "Metal", "Wood" }, Default = "None" })

    local weapon = right:Page("Weapon")
    weapon:Toggle({ Name = "No Recoil", Default = true, Help = "remove weapon recoil" })
    weapon:Slider({ Name = "Recoil Scale", Default = 0, Suffix = "%" })
    weapon:Toggle({ Name = "No Spread", Default = true, Help = "remove weapon spread" })
    weapon:Toggle({ Name = "No Sway", Help = "remove scope sway" })
    weapon:Toggle({ Name = "Instant Bow", Help = "release bows at full draw" })
    weapon:Slider({ Name = "Fire Rate", Default = 100, Min = 25, Max = 400, Suffix = "%" })
    weapon:Dropdown({ Name = "Ammo Type",
        Values = { "Default", "HV", "Incendiary", "Explosive" }, Default = "Default" })
end

do
    local visuals = win:Tab("Visuals")
    local left = visuals:Panel({ Side = "left", Tabs = { "Players", "World" } })
    local right = visuals:Panel({ Side = "right", Tabs = { "Chams", "Overlay" } })

    local players = left:Page("Players")
    players:Toggle({ Name = "Player ESP", Default = true, Key = "p", Color = white,
        Help = "master switch for player esp" })
    players:Dropdown({ Name = "Box Style", Values = { "Off", "2D", "Corner", "3D" },
        Default = "Corner" })
    players:Toggle({ Name = "Name", Default = true, Color = C(236, 237, 239) })
    players:Toggle({ Name = "Distance", Default = true })
    players:Toggle({ Name = "Health Bar", Default = true, Color = C(120, 220, 130) })
    players:Toggle({ Name = "Held Item", Default = true })
    players:Toggle({ Name = "Skeleton", Help = "draw the bone chain" })
    players:Slider({ Name = "Text Size", Default = 13, Min = 8, Max = 24, Suffix = "px" })
    players:Slider({ Name = "Render Distance", Default = 300, Max = 1000, Suffix = "m" })
    players:Toggle({ Name = "Team Check", Default = true, Help = "hide teammates" })
    players:Toggle({ Name = "Sleeper ESP", Help = "also draw sleeping players" })

    local world = left:Page("World")
    world:Toggle({ Name = "Dropped Items", Default = true, Color = C(255, 200, 90) })
    world:Toggle({ Name = "Stashes", Default = true, Help = "reveal buried stashes" })
    world:Toggle({ Name = "Traps", Default = true, Color = C(240, 96, 96) })
    world:Toggle({ Name = "Ore Nodes" })
    world:Toggle({ Name = "Animals" })
    world:Dropdown({ Name = "Loot Filter", Multi = true,
        Values = { "Weapons", "Ammo", "Components", "Medical", "Food" },
        Default = { Weapons = true, Ammo = true } })
    world:Slider({ Name = "World Distance", Default = 150, Max = 600, Suffix = "m" })

    local chams = right:Page("Chams")
    chams:Toggle({ Name = "Player Chams", Default = true, Color = C(182, 128, 242) })
    chams:Dropdown({ Name = "Visible Style", Values = { "Flat", "Glow", "Texture" },
        Default = "Flat" })
    chams:Toggle({ Name = "Hidden Chams", Default = true, Color = C(255, 110, 110) })
    chams:Slider({ Name = "Chams Alpha", Default = 70, Suffix = "%" })
    chams:Toggle({ Name = "Item Chams" })

    local overlay = right:Page("Overlay")
    overlay:Toggle({ Name = "Watermark", Default = true })
    overlay:Toggle({ Name = "Keybind List", Default = true, Help = "list the active binds" })
    overlay:Toggle({ Name = "Spectator List", Default = true, Help = "who is watching you" })
    overlay:Toggle({ Name = "FPS Counter" })
    overlay:Dropdown({ Name = "Corner",
        Values = { "Top Left", "Top Right", "Bottom Left", "Bottom Right" },
        Default = "Top Right" })
    overlay:Slider({ Name = "Overlay Alpha", Default = 90, Min = 20, Suffix = "%" })
end

do
    local world = win:Tab("World")
    local left = world:Panel({ Side = "left", Tabs = { "Resources", "Vehicles & Animals" } })
    local right = world:Panel({ Side = "right", Tabs = { "World", "Deployables" } })

    local function shelf(page, rows)
        for _, row in ipairs(rows) do
            local item = page:Toggle({ Name = row[1], Default = row[2], Color = row[3],
                Option = true })
            item.option:Toggle({ Name = "Name", Default = true })
            item.option:Toggle({ Name = "Distance", Default = true })
            item.option:Slider({ Name = "Max Range", Default = 250, Max = 1000, Suffix = "m",
                Width = 160 })
        end
    end

    shelf(left:Page("Resources"), {
        { "Hemp",          true,  C(  0, 255,   0) },
        { "Sulfur Ore",    true,  C(191, 255,   0) },
        { "Metal Ore",     true,  C(254, 168,   1) },
        { "Stone Ore",     true,  C(222, 222, 222) },
        { "Sulfur Pickup", false, C(192, 255,   5) },
        { "Metal Pickup",  false, C(253, 166,   7) },
        { "Stone Pickup",  false, C(222, 222, 222) },
        { "Wood Pickup",   false, C(246,  79,  65) },
        { "Pumpkin",       false, C(252, 145,   2) },
        { "Corn",          false, C(253, 220,   2) },
        { "Potato",        false, C(252, 210, 108) },
        { "Mushroom",      false, C(253, 144,  97) },
        { "Food Crate",    false, C( 55, 253, 168) },
        { "Oil Barrel",    false, C(203,  42,  42) },
        { "Scrap Barrel",  false, C( 46, 146, 238) },
        { "Diesel",        false, C(222, 222, 222) },
    })

    shelf(left:Page("Vehicles & Animals"), {
        { "Minicopter",  true,  C(120, 200, 255) },
        { "Scrap Heli",  true,  C( 90, 170, 255) },
        { "Boat",        false, C( 70, 200, 220) },
        { "Horse",       true,  C(210, 160, 110) },
        { "Bear",        false, C(150,  90,  50) },
        { "Wolf",        false, C(190, 190, 190) },
        { "Boar",        false, C(160, 120,  90) },
        { "Chicken",     false, C(250, 230, 170) },
        { "Patrol Heli", true,  C(255,  70,  70) },
        { "Bradley APC", true,  C(255, 120,  40) },
    })

    local worldPage = right:Page("World")
    local dropped = worldPage:Toggle({ Name = "Dropped Weapons", Default = true,
        Color = C(54, 255, 173), Option = true })
    dropped.option:Toggle({ Name = "Name", Default = true })
    dropped.option:Slider({ Name = "Max Range", Default = 300, Max = 1000, Suffix = "m",
        Width = 160 })
    worldPage:Toggle({ Name = "Dropped Item Chams", Default = true, Pad = -10,
        Color = C(157, 255, 197), Color2 = C(166, 128, 255),
        Help = "recolour every dropped item" })
    worldPage:Dropdown({ Name = "Cham Type", Nested = true, Width = 125, Height = 24, Pad = -6,
        Values = { "Vischeck", "Flat", "Glow", "Outline" }, Default = "Vischeck" })
    shelf(worldPage, {
        { "Large Backpack", false, C(  0, 146,   3) },
        { "Small Backpack", false, C(  0, 146,   3) },
        { "Corpse",         true,  C(249,  27,  66) },
        { "Hackable Crate", false, C(245,  28,  62) },
        { "Airdrop",        false, C(  1, 246, 254) },
        { "Bradley Crate",  false, C(194, 254,   0) },
        { "Heli Crate",     false, C(  2, 254,  64) },
        { "Elite Crate",    false, C(163, 253,   4) },
        { "Military Crate", false, C( 42, 255,   0) },
        { "Basic Crate",    false, C(233, 255,   2) },
        { "Tool Crate",     false, C(255,  65,   1) },
    })

    shelf(right:Page("Deployables"), {
        { "Tool Cupboard", true,  C(255, 200,  90) },
        { "Auto Turret",   true,  C(255,  80,  80) },
        { "SAM Site",      true,  C(255, 140,  60) },
        { "Sleeping Bag",  false, C(180, 180, 180) },
        { "Furnace",       false, C(255, 170,  70) },
        { "Box",           false, C(200, 160, 110) },
        { "Door",          false, C(160, 160, 170) },
        { "Trap",          true,  C(240,  60,  60) },
    })
end

do
    local misc = win:Tab("Misc")
    local left = misc:Panel({ Side = "left", Tabs = { "Movement", "Anti Aim" } })
    local right = misc:Panel({ Side = "right", Tabs = { "Server", "Chat" } })

    local move = left:Page("Movement")
    move:Toggle({ Name = "Speed Hack", Key = "x", Help = "multiply the movement speed" })
    move:Slider({ Name = "Speed Amount", Default = 150, Min = 100, Max = 400, Suffix = "%" })
    move:Toggle({ Name = "Fly", Key = "f", Help = "free flight" })
    move:Slider({ Name = "Fly Speed", Default = 60, Min = 10, Max = 300 })
    move:Toggle({ Name = "No Fall Damage", Default = true })
    move:Toggle({ Name = "Infinite Jump" })
    move:Toggle({ Name = "Spider Climb", Help = "walk up vertical surfaces" })
    move:Toggle({ Name = "No Slowdown", Default = true })
    move:Keybind({ Name = "Panic Key", Default = "delete", Mode = "toggle" })

    local anti = left:Page("Anti Aim")
    anti:Toggle({ Name = "Anti Aim", Key = "v", Help = "fake the server side angles" })
    anti:Dropdown({ Name = "Yaw Base", Values = { "Local View", "At Target", "Spin" },
        Default = "Local View" })
    anti:Slider({ Name = "Yaw Offset", Default = 0, Min = -180, Max = 180, Suffix = "deg" })
    anti:Dropdown({ Name = "Pitch", Values = { "None", "Down", "Up", "Zero" }, Default = "Down" })
    anti:Slider({ Name = "Spin Speed", Default = 0, Suffix = "%" })
    anti:Toggle({ Name = "Fake Lag", Help = "hold packets back" })
    anti:Slider({ Name = "Lag Amount", Default = 14, Min = 1, Max = 20 })

    local server = right:Page("Server")
    server:Toggle({ Name = "Anti AFK", Default = true, Help = "never get kicked for idling" })
    server:Toggle({ Name = "Auto Reconnect", Default = true })
    server:Slider({ Name = "Reconnect Delay", Default = 5, Min = 1, Max = 60, Suffix = "s" })
    server:Toggle({ Name = "Ping Spoof", Help = "report a fake ping" })
    server:Slider({ Name = "Fake Ping", Default = 60, Max = 400, Suffix = "ms" })
    server:TextBox({ Name = "Webhook", Placeholder = "https://" })

    local chat = right:Page("Chat")
    chat:Toggle({ Name = "Chat Spam", Help = "repeat a line on a timer" })
    chat:TextBox({ Name = "Spam Text", Placeholder = "message" })
    chat:Slider({ Name = "Spam Delay", Default = 5, Min = 1, Max = 60, Suffix = "s" })
    chat:Toggle({ Name = "Log Kills", Default = true })
    chat:Toggle({ Name = "Log Damage" })
end

do
    local settings = win:Tab("Settings")
    local left = settings:Panel({ Side = "left", Tabs = { "Interface", "Palette", "Binds" } })
    local right = settings:Panel({ Side = "right", Tabs = { "Config", "About" } })

    local face = left:Page("Interface")
    face:Toggle({ Name = "Animations", Default = true })
    face:Toggle({ Name = "Tooltips", Default = true, Help = "the little help popups" })
    face:Slider({ Name = "Menu Opacity", Default = 100, Min = 40, Suffix = "%" })
    face:Dropdown({ Name = "Font Size", Values = { "Small", "Normal", "Large" },
        Default = "Normal" })
    face:Toggle({ Name = "Lock Position", Help = "stop the window from being dragged" })
    ...
    binds:Keybind({ Name = "Anti Aim Key", Default = "v" })
    binds:Toggle({
        Name = "Show Binds",
        Default = true,
    ...
    config:Toggle({ Name = "Auto Save", Default = true })

    local about = right:Page("About")
    about:Label({ Name = "disconnect.wtf" })
    about:Label({ Name = "build 1.0.0" })
    about:Label({ Name = "press F1 to toggle" })
end

Menu.notify("disconnect.wtf", "press F1 to toggle", 4)
